//
// impl/use_fiber_future.hpp
// ~~~~~~~~~~~~~~~~~~~
//
// Copyright (c) 2003-2018 Christopher M. Kohlhoff (chris at kohlhoff dot com)
// Copyright (c) 2018-2019 Whale Mo ( whalemo at kouga dot us)
//
// Distributed under the Boost Software License, Version 1.0. (See accompanying
// file LICENSE_1_0.txt or copy at http://www.boost.org/LICENSE_1_0.txt)
//

#ifndef BOOST_ASIO_IMPL_USE_FIBER_FUTURE_HPP
#define BOOST_ASIO_IMPL_USE_FIBER_FUTURE_HPP
...
inline void promise_invoke_and_set(boost::fibers::promise<T>& p, F& f)
{
#if !defined(BOOST_ASIO_NO_EXCEPTIONS)
  try
#endif // !defined(BOOST_ASIO_NO_EXCEPTIONS)
...
template <typename F, typename Args>
inline void promise_invoke_and_set(boost::fibers::promise<void>& p, F& f)
{
#if !defined(BOOST_ASIO_NO_EXCEPTIONS)
  try
#endif // !defined(BOOST_ASIO_NO_EXCEPTIONS)
...
class async_result<fibers::use_future_t<Allocator>, Result()>
  : public fibers::detail::promise_async_result<void(), Allocator>
{
public:
  explicit async_result(
    typename fibers::detail::promise_async_result<
      void(), Allocator>::completion_handler_type& h)
    : fibers::detail::promise_async_result<void(), Allocator>(h)
  {
  }
};

template <typename Function, typename Allocator, typename Result>
class async_result<fibers::detail::packaged_token<Function, Allocator>, Result()>
  : public fibers::detail::packaged_async_result<Function, Allocator,
...
#define BOOST_ASIO_PRIVATE_ASYNC_RESULT_DEF(n) \
  ...
  class async_result<fibers::use_future_t<Allocator>, \
  ...
  template <typename Function, typename Allocator, \
      typename Result, BOOST_ASIO_VARIADIC_TPARAMS(n)> \
  class async_result<fibers::detail::packaged_token<Function, Allocator>, \
      Result(BOOST_ASIO_VARIADIC_TARGS(n))> \
    : public fibers::detail::packaged_async_result<Function, Allocator, \
...
struct handler_type<fibers::use_future_t<Allocator>, Signature>
{
  typedef typename async_result<fibers::use_future_t<Allocator>,
    Signature>::completion_handler_type type;
};

template <typename Signature, typename Allocator>
class async_result<fibers::detail::promise_handler<Signature, Allocator> >
  : public fibers::detail::promise_async_result<Signature, Allocator>
{
public:
  typedef typename fibers::detail::promise_async_result<
    Signature, Allocator>::return_type type;

  explicit async_result(
    typename fibers::detail::promise_async_result<
      Signature, Allocator>::completion_handler_type& h)
    : fibers::detail::promise_async_result<Signature, Allocator>(h)
  {
  }
};

template <typename Function, typename Allocator, typename Signature>
struct handler_type<fibers::detail::packaged_token<Function, Allocator>, Signature>
{
  typedef typename async_result<fibers::detail::packaged_token<Function, Allocator>,
    Signature>::completion_handler_type type;
};

template <typename Function, typename Allocator, typename Result>
class async_result<fibers::detail::packaged_handler<Function, Allocator, Result> >
  : public fibers::detail::packaged_async_result<Function, Allocator, Result>
{
public:
  typedef typename fibers::detail::packaged_async_result<
    Function, Allocator, Result>::return_type type;

  explicit async_result(
    typename fibers::detail::packaged_async_result<
      Function, Allocator, Result>::completion_handler_type& h)
    : fibers::detail::packaged_async_result<Function, Allocator, Result>(h)
  {
  }
};
...
#endif // BOOST_ASIO_IMPL_USE_FIBER_FUTURE_HPP
