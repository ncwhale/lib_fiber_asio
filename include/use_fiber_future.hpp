...
#ifndef BOOST_ASIO_USE_FIBER_FUTURE_HPP
#define BOOST_ASIO_USE_FIBER_FUTURE_HPP
 ...
 * should return a boost::fibers::future object. A use_future_t object may be
 * passed as a handler to an asynchronous operation, typically using the special
 * value @c boost::asio::use_future. For example:
 *
...
class use_future_t {
 public:
   ...
   * operation, the result of the function object is retuned via a
   * boost::fibers::future.
   *
   * @par Example
   *
   * @code boost::fibers::future<std::size_t> fut =
...
/**
 * See the documentation for boost::asio::fibers::use_future_t for a usage example.
 */
...
#include "impl/use_fiber_future.hpp"

#endif  // BOOST_ASIO_USE_FIBER_FUTURE_HPP
