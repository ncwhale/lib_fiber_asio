...
/**
 * The use_fiber_future_t class is used to indicate that an asynchronous
 * operation should return a boost::fibers::future object. A use_fiber_future_t
 * object may be passed as a handler to an asynchronous operation, typically
 * using the special value @c boost::asio::use_fiber_future. For example:
 *
...
constexpr use_fiber_future_t<> use_future;
